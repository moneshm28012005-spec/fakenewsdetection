				...
				<div class="rgt_hd">					
					<div class="main_menu">
						...
						<div id="navbar">
							...
							<ul>
								<li><a class="page-scroll" href="AtHome.jsp">Add Block URL</a></li>
								<li><a class="page-scroll" href="AtView.jsp">View URL</a></li>
		...
		<div class="row">
			...
			<div class="col-sm-6" style="margin-top: 89px;"> 
				<div id="cnt_form">
					...
					<h1><p align="center">View Add URL</p></h1>
					<br><br>
					
					<table align="center" border="3" width="900px" style="background-color:black;margin-left: 135px;">
					<tr>
	     	...
	     	%>
                <tr> <th style="color:yellow;"><center><%=a%></center></th>
				<th style="color:yellow;"><center><%=b%></center></th>
				<th style="color:yellow;"><%=c%></center></th>
